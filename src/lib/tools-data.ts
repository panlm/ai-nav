...
const mockOnlyTools: Tool[] = [
  ...
  },
  {
    ...
    openSource: false,
    modelBase: [],
    ratings: { overall: 4.1, easeOfUse: 4.5, valueForMoney: 4.0, outputQuality: 3.8, reviewCount: 0 },
    review: { tested: false },
    workflowTags: [],
    status: 'published',
    featured: false,
  ...
  },
  {
    ...
    openSource: false,
    modelBase: [],
    ratings: { overall: 4.0, easeOfUse: 4.5, valueForMoney: 4.0, outputQuality: 3.8, reviewCount: 0 },
    review: { tested: false },
    workflowTags: [],
    status: 'published',
    featured: false,
